<?php
    ...
    if($request != null){
		...
		$sql = "INSERT INTO contrat(numContrat, cinMarchand, numPlace, codeActivite, annee, debPayement, dateContrat)
                 VALUES ('".$numContrat."', '".$cinMarchand."', '".$numPlace."', '".$codeActivite."', '".$annee."', '".$debPayement."', '".$dateContrat."')";
