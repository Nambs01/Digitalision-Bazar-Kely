<?php
  ...
  if($request != null){
    ...
    $result =  $conn->query("
        ...
        FROM
              contrat
          LEFT JOIN payement ON contrat.numPlace = payement.numPlace AND payement.dateContrat = contrat.dateContrat AND payement.datePaye BETWEEN '".$dateDeb."' AND '".$dateFin."' 
