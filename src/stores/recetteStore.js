        ...
        state.recettes.map( recette => {
            ...
            if (recette.codeMarche == recettesParMarche[recettesParMarche.length-1].codeMarche) {
              ...
              recettesParMarche.push({ 
                ...
                montantMin: dayWithoutSunday( (recette.debutPayement > state.dateDeb ? recette.debutPayement : state.dateDeb ), state.dateFin) * recette.taux
              })    
      ...
      if(recettesParMarche[0]){
        ...
        recettesParMarche.map( recette => {
          ...
          if(recette.codePercepteur === recettesParPercepteur[recettesParPercepteur.length-1].codePercepteur){
            ...
            recettesParPercepteur[recettesParPercepteur.length-1].montantMin += ( dayWithoutSunday( (recette.debutPayement > state.dateDeb ? recette.debutPayement : state.dateDeb), state.dateFin) * recette.taux )
