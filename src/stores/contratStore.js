...
export const useContratStore = defineStore('contratStore', {
    ...
    actions: {
        ...
        addContrat(numContratVal, cinMarchandVal, nomMarcheVal, numPlaceVal, codeActiviteVal, anneeVal, debPayementVal, dateContratVal) {
        ...
        updateContrat(numContratVal, cinMarchandVal, codeActiviteVal, newDateContratVal, debPayementVal, valideVal, oldDateContratVal) {
