    ...
    <div class="container">
      ...
      <form @submit="saveContrat" class="was-validated pb-4">
        ...
        <div class="mb-4">
          ...
          <select name="marche" id="marche" v-model="contrat.nomMarche">
            <option></option>
        ...
        <div class="mb-3">
          ...
          <select name="numPlace" id="numPlace" :disabled="!isMarcheSelected" v-model="contrat.numPlace">
            <option></option>
            <option v-for="place in placeStore.getPlacesDisponibleByCodeMarche(marcheStore.getCodeMarcheByNomMarche(contrat.nomMarche))">{{ place.numPlace }}</option>
          </select>
...
watch(()=>contrat.nomMarche, (newNom, oldNom)=>{
  contrat.numPlace = ''
...
const saveContrat = (event)=>{
  ...
  if(!isCINExisted.value){
    ...
    cinRef.value.focus()
      ...
      contratStore.addContrat(contrat.numContrat, contrat.cinMarchand, contrat.nomMarche, contrat.numPlace, contrat.codeActivite, contrat.annee, contrat.debPayement, contrat.dateContrat)
