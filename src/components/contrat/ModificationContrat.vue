    ...
    <div class="container">
      ...
      <form class="was-validated" @submit="saveChange">
        ...
        <div class="mb-3 col-sm-6">
          ...
          <input type="number" ref="cinRef" v-model="contrat.cinMarchand" class="form-control" id="cin" name="cin" required max="999999999999" min="100000000000">
        ...
        <div class="mb-3 col-sm-6" v-if="contrat.dernierPayement == '0000-00-00' ">
          ...
          <input type="date" v-model="contrat.debPayement" class="form-control" id="debPayement" name="debPayement" required>
        </div>
...
const saveChange = (event)=>{
  ...
  if(isCINExisted.value){
    contratStore.updateContrat(route.params.numContrat, contrat.cinMarchand, contrat.codeActivite, contrat.dateContrat, contrat.debPayement, contrat.valide, route.params.dateContrat)
